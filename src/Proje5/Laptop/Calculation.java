...
public class Calculation {
    ...
    public static int getRam(ArrayList<String> arrayList){
        ...
        for (int i = 0; i < arrayList.size(); i++) {
            ...
            if (arrayList.get(i).contains("32 gb")){
                price+=300;
            } else if (arrayList.get(i).contains("16 gb")){
                price+=200;
            } else if (arrayList.get(i).contains("8 gb")){
                price+=100;
            } else if (arrayList.get(i).contains("4 gb")){
                price+=50;
            }
        }
        return price;
    ...
    public static int getCPU(ArrayList<String> arrayList){
        ...
        for (int i = 0; i < arrayList.size(); i++) {
            ...
            if (arrayList.get(i).contains("i3")){
                price+=200;
            } else if (arrayList.get(i).contains("i5")){
                price+=300;
            } else if (arrayList.get(i).contains("i7")){
                price+=500;
            }
        }
   ...
   */
    ...
    public static int getColor(ArrayList<String> arrayList){
        ...
        for (int i = 0; i < arrayList.size(); i++) {
            ...
            if (arrayList.get(i).contains("Red")){
                price+=400;
            } else if (arrayList.get(i).contains("Orange")){
                price+=300;
            } else if (arrayList.get(i).contains("Silver")){
                price+=200;
            } else if (arrayList.get(i).contains("Black")){
                price+=150;
            }
        }
        return price;
